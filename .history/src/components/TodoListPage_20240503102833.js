...
const TodoListPage = () => {
    ...
    return (
        <div>
            ...
            <Container style={{ boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2)', padding: '50px', marginTop: '50px', position: 'relative' }}>
                {showMessage &&
                    <Message
                        success
                        ...
                        style={{ position: 'absolute', top: '-70px', left: 0, right: 0, margin: 'auto', width: '100%' }}
                    />
                }
                <div>
                    <Table celled>
