...
import EditTodoModal from './EditTodoModal'; // Import EditTodoModal component
...
const TodoListPage = () => {
    ...
    const [editTodo, setEditTodo] = useState(null); // State to manage the todo item being edited
    const [openEditModal, setOpenEditModal] = useState(false); // State to manage the edit modal visibility
    ...
    const handleEdit = (todo) => {
        setEditTodo(todo); // Set the todo item to edit
    ...
    return (
        <div>
                                    ...
                                    <Table.Row key={todo.id}>
                                        ...
                                        <Table.Cell>
                                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                                <Button icon color='blue' onClick={() => handleEdit(todo)}> {/* Edit button */}
                                                    <Icon name='edit' />
                                                </Button>
            ...
            <EditTodoModal
                ...
                todo={editTodo} // Pass the todo item to edit modal
            />
        </div>
    );
};
